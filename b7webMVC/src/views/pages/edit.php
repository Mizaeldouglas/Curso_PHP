...
<body>
  <div class="quoteForm" id="quoteFormContain">
    ...
    <form action="<?= $base; ?>/usuario/<?= $usuario['id']; ?>/editar" method="post" class="material-form">

      <h1 style="font-weight: 300;">Editar Usuário</h1><br />
      <section class="material-form-field">
        <div class="material-form-field-controls">
          <div class="form-field-controls-group">
            <input type="text" value="<?= $usuario['nome'] ?>" name="name" placeholder="Name"
        ...
        <div class="material-form-field-controls">
          <div class="form-field-controls-group">
            <input type="email" value="<?= $usuario['email'] ?>" name="email" placeholder="Email"
              title="Please enter Email" class="material-form-field-input">
            <label class="material-form-field-label">Email</label>
          </div>
        </div>
      </section>
      <br />
      <input type="submit" value="SALAR" class="formButton">
    </form>
  </div>
</body>
